...
d3.json(url).then(function(data) {
    ...
    function buildCharts(sample) {
        ...
        let selectedSampleData = data.samples.find(sampleObj => sampleObj.id == sample);
        ...
        // Plot the bar chart
        let topotu = selectedSampleData["otu_ids"].slice(0, 10).map(item => "out" + item).reverse();
